...
class Main {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Hello, you currently have " + money + " currency."); //Log that they have x amount of money.

    //we have our loop that goes for as long as the user plays
    for(;;){
      System.out.println("If you would like to play type 1, if you would like to shop type 2, and if you would like to quit type 3");
    ...
    public static int shop(int x){
      ...
      System.out.println("Welcome to the shop o'cram, we have a variety of cram. Type 1 if you would like to buy Mixed Berry Cram, type 2 if you would like to buy Very Berry Cram, and type 3 if you would like to buy Raspberry Cram.");
